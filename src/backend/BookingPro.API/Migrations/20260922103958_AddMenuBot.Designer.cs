...
namespace BookingPro.API.Migrations
{
    ...
    [Migration("20260922103958_AddMenuBot")]
    partial class AddMenuBot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.BookingConfirmationRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("booking_confirmation_requests", (string)null);
                });
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.ChytapayOAuthConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IdTokenExpiresAt");

                    b.HasIndex("IsActive");

                    b.HasIndex("TenantId");

                    b.ToTable("chytapay_oauth_configurations", (string)null);
                });

            modelBuilder.Entity("BookingPro.API.Models.Entities.ChytapayOAuthState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("chytapay_oauth_states", (string)null);
                });

            modelBuilder.Entity("BookingPro.API.Models.Entities.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.EmailLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.EmailVerification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.Employee", b =>
                {
                    ...
                    b.Property<bool?>("AllowSimultaneousBookings")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.FeatureAddon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("feature_addons", "public");
                });

            modelBuilder.Entity("BookingPro.API.Models.Entities.FeatureAddonPurchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("feature_addon_purchases", (string)null);
                });

            modelBuilder.Entity("BookingPro.API.Models.Entities.FollowupSequenceLocal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("followup_sequences_local", "public");
                });

            modelBuilder.Entity("BookingPro.API.Models.Entities.IncomingPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("SuggestedBookingId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "MpPaymentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.MenuBotSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MenuBotSessions");
                });

            modelBuilder.Entity("BookingPro.API.Models.Entities.MenuBotSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("MinBookingAdvanceMinutes")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.NotificationSettings", b =>
                {
                    ...
                    b.Property<int>("FollowUpDelayMinutes")
                        .HasColumnType("integer");

                    b.Property<bool>("FollowUpEmailEnabled")
                        .HasColumnType("boolean");

                    b.Property<string>("FollowUpEmailTemplateKey")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<bool>("FollowUpWhatsAppEnabled")
                        .HasColumnType("boolean");

                    b.Property<string>("FollowUpWhatsAppMessage")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.PayerCustomerMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "PayerKey")
                        .IsUnique();

                    b.ToTable("PayerCustomerMappings");
                });
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.PhoneVerification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("phone_verifications", "public");
                });
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.PlatformPaymentConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PlatformPaymentConnections");
                });

            modelBuilder.Entity("BookingPro.API.Models.Entities.PlatformWhatsAppConnection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("platform_whatsapp_connections", "public");
                });
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.Subscription", b =>
                {
                    ...
                    b.Property<DateTime?>("AppleExpiresAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<decimal?>("OriginalMonthlyPrice")
                        .HasColumnType("numeric");

                    b.Property<bool>("PaidViaApple")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.Tenant", b =>
                {
                    ...
                    b.Property<string>("BusinessVolume")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)");

                    b.Property<string>("BusinessWorkMode")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");
                    ...
                    b.Property<DateTime?>("ExportedToSalesHubAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("MetaAttributionAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("MetaAttributionSource")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)");
                    ...
                    b.Property<int>("OnboardingFollowupCount")
                        .HasColumnType("integer");

                    b.Property<bool>("OnboardingFollowupDone")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("OnboardingLastFollowupAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("OwnerInstagram")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.TenantFeatureAddon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "AddonCode")
                        .IsUnique();

                    b.ToTable("tenant_feature_addons", (string)null);
                });
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.TenantMessagingSettings", b =>
                {
                    ...
                    b.Property<int>("ConfirmationAdvanceMinutes")
                        .HasColumnType("integer");

                    b.Property<bool>("ConfirmationBotEnabled")
                        .HasColumnType("boolean");

                    b.Property<string>("ConfirmationTemplate")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.TransferDetectionSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TransferDetectionSettings");
                });
            ...
            modelBuilder.Entity("BookingPro.API.Models.Entities.WhatsAppReceiptClaim", b =>
                {
                    ...
                    b.ToTable("WhatsAppReceiptClaims");
                });
